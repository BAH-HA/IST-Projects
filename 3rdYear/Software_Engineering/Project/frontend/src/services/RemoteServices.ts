...
export default class RemoteServices {
  ...
  static async createAssessment(userId: number,institutionId: number | null, assessment: Assessment){
    return httpClient
  ...
  static async getVolunteerAssessments(volunteerId: number | null
  ): Promise<Assessment[]> {
    return httpClient
      .get('/institutions/assessments')
      .then((response) => {
        return response.data.map((assessment: any) => {
          return new Assessment(assessment);
        });
  ...
  static async getVolunteerParticipations(volunteerId: number | null
    ): Promise<Participation[]> {
      return httpClient
        .get('/activities/volunteer')
        .then((response) => {
  ...
  static async createParticipation(
      activityId: number | null,
      participation: { activityId: number | null; rating: number | null; volunteerId: number | null },
  ): Promise<Participation> {
    return httpClient
