...
Cypress.Commands.add('createDemoEnrollments', () => {
	cy.task('queryDatabase', {
...
Cypress.Commands.add('createDemoParticipations', () => {
  cy.task('queryDatabase', {
    query: "INSERT INTO " + INSTITUTION_COLUMNS + "VALUES ('1', 't', 'abca428c09862e89', '2024-02-06 17:58:21.402146', 'demo_institution@mail.com', 'DEMO INSTITUTION', '000000000', '2024-02-06 17:58:21.402134')",
    credentials: credentials,
  })
  ...
  cy.task('queryDatabase', {
    query: "INSERT INTO " + USER_COLUMNS + "VALUES ('VOLUNTEER', '4', '2024-02-06 17:58:23.732513', 'DEMO-VOLUNTEER2', 'VOLUNTEER', 'ACTIVE', NULL);",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + USER_COLUMNS + "VALUES ('VOLUNTEER', '5', '2024-02-06 17:58:23.732513', 'DEMO-VOLUNTEER3', 'VOLUNTEER', 'ACTIVE', NULL);",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + AUTH_USERS_COLUMNS + "VALUES ('DEMO', '2', 't', 'demo_member@mail.com', 'demo-member', '2')",
  ...
  cy.task('queryDatabase', {
    query: "INSERT INTO " + AUTH_USERS_COLUMNS + "VALUES ('DEMO', '4', 't', 'demo_volunteer@mail.com', 'demo-volunteer-2', '4')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + AUTH_USERS_COLUMNS + "VALUES ('DEMO', '5', 't', 'demo_volunteer@mail.com', 'demo-volunteer-3', '5')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ACTIVITY_COLUMNS + "VALUES ('1', '2024-02-06 17:58:21.402146', '2024-01-06 17:58:21.402146', 'Has vacancies', '2024-02-08 17:58:21.402146', 'A1', '2', 'Lisbon', '2024-02-07 17:58:21.402146', 'APPROVED', '1')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ACTIVITY_COLUMNS + "VALUES ('2', '2024-02-06 17:58:21.402146', '2024-01-06 17:58:21.402146', 'Has no vacancies', '2024-02-08 17:58:21.402146', 'A2', '1', 'Lisbon', '2024-02-07 17:58:21.402146', 'APPROVED', '1')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
  ...
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ENROLLMENT_COLUMNS + "VALUES ('2', '2024-02-06 19:51:37.595713', 'Has vacancies and participate', '1', '4')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
  ...
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ENROLLMENT_COLUMNS + "VALUES ('4', '2024-02-06 20:51:37.595713', 'Has no vacancies and do not participate', '2', '5')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
...
Cypress.Commands.add('createDemoAssessments', () => {
  ...
  cy.task('queryDatabase', {
    query: "INSERT INTO " + INSTITUTION_COLUMNS + "VALUES ('2', 't', 'abca428c09862e89', '2024-02-06 17:58:21.402146', 'demo_institution@mail.com', 'DEMO INSTITUTION', '000000000', '2024-02-06 17:58:21.402134')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + USER_COLUMNS + "VALUES ('MEMBER', '2', '2024-02-06 17:58:21.419878', 'DEMO-MEMBER', 'MEMBER', 'ACTIVE', '1');",
  ...
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ACTIVITY_COLUMNS + "VALUES ('1', '2024-02-06 17:58:21.402146', '2024-01-06 17:58:21.402146', 'Same institution is enrolled and participates', '2024-02-08 17:58:21.402146', 'A1', '1', 'Lisbon', '2024-02-07 17:58:21.402146', 'APPROVED', '1')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ACTIVITY_COLUMNS + "VALUES ('2', '2024-02-06 17:58:21.402146', '2024-01-06 17:58:21.402146', 'Same institution is enrolled and participates', '2024-02-08 17:58:21.402146', 'A2', '1', 'Lisbon', '2024-02-07 17:58:21.402146', 'APPROVED', '1')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ACTIVITY_COLUMNS + "VALUES ('3', '2024-02-06 17:58:21.402146', '2024-01-06 17:58:21.402146', 'Same institution is enrolled and does not participate', '2024-02-08 17:58:21.402146', 'A3', '2', 'Lisbon', '2024-02-07 17:58:21.402146', 'APPROVED', '1')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ACTIVITY_COLUMNS + "VALUES ('4', '2024-02-06 17:58:21.402146', '2024-01-06 17:58:21.402146', 'Same institution is not enrolled', '2024-02-08 17:58:21.402146', 'A4', '2', 'Lisbon', '2024-02-07 17:58:21.402146', 'APPROVED', '1')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ACTIVITY_COLUMNS + "VALUES ('5', '2024-02-06 17:58:21.402146', '2024-01-06 17:58:21.402146', 'Same institution before end date', '2024-08-08 10:58:21.402146', 'A5', '2', 'Lisbon', '2024-02-07 17:58:21.402146', 'APPROVED', '1')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ACTIVITY_COLUMNS + "VALUES ('6', '2024-02-06 17:58:21.402146', '2024-01-06 17:58:21.402146', 'Other institution is enrolled and participates', '2024-02-08 17:58:21.402146', 'A6', '3', 'Lisbon', '2024-02-07 17:58:21.402146', 'APPROVED', '2')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ENROLLMENT_COLUMNS + "VALUES ('1', '2024-02-06 18:51:37.595713', 'sql-inserted-motivation', '1', '3')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ENROLLMENT_COLUMNS + "VALUES ('2', '2024-02-06 18:51:37.595713', 'sql-inserted-motivation', '2', '3')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ENROLLMENT_COLUMNS + "VALUES ('3', '2024-02-06 18:51:37.595713', 'sql-inserted-motivation', '3', '3')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ENROLLMENT_COLUMNS + "VALUES ('4', '2024-02-06 18:51:37.595713', 'sql-inserted-motivation', '6', '3')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + PARTICIPATION_COLUMNS + "VALUES ('1', '2024-02-06 18:51:37.595713', '5', '1', '3')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + PARTICIPATION_COLUMNS + "VALUES ('2', '2024-02-06 18:51:37.595713', '5', '2', '3')",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + PARTICIPATION_COLUMNS + "VALUES ('3', '2024-02-06 18:51:37.595713', '5', '6', '3')",
    credentials: credentials,
  })
});
